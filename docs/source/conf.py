...
myst_html_meta = {
    "description": "IP2Proxy Haskell package enables user to query an IP address if it was being used as open proxy, web proxy, VPN anonymizer and TOR exits.",
    "keywords": "IP2Proxy, Proxy, IP location, Haskell",
...
html_title = "IP2Proxy Haskell"

# html_baseurl = "https://ip2proxy-haskell.readthedocs.io/en/latest/"